...
function bandaid_scripts() {
    ...
    wp_enqueue_script('scripts', get_template_directory_uri() . '/js/scripts.js?ver='.$ver, array('jquery'), null, true);
    wp_enqueue_script('scripts');
    wp_enqueue_script('bandaid-bootstrap4alpha-js', get_template_directory_uri() . '/js/bootstrap.min.js', array('jquery'), '1.0.0', true);
    wp_enqueue_script('bandaid-slick-js', get_template_directory_uri() . '/js/slick.min.js', array('jquery'), '1.0.0', true);
    wp_enqueue_script('bandaid-jquery-modal-js', get_template_directory_uri() . '/js/jquery.modal.min.js', array('jquery'), '1.0.0', true);
...
// Newsroom sidebar
register_sidebar(array('name' => __('Newsroom Sidebar', 'exquisite'), 'id' => 'newsroom-sidebar', 'description' => __('Newsroom widgets.', 'exquisite'), 'before_widget' => '<div id="%1$s" class="widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h3>', 'after_title' => '</h3>'));
...
function addcssAndScripts() {
    if (is_page('free-margin-assessment')) {
        wp_enqueue_style('margin-calculator-core-style', get_template_directory_uri() . '/css/margin-calculator-core.css');
    }
}
...
function get_platforms_sidebar_func() {
    $side_bar = get_sidebar('platforms');
    return $side_bar;
}
add_shortcode( 'platforms_sidebar', 'get_platforms_sidebar_func' );

function get_category_pages_sidebar_func() {
    $side_bar = get_sidebar('platforms');
    return $side_bar;
}
add_shortcode( 'cateogry_page_sidebar', 'get_category_pages_sidebar_func' );
function get_category_page_sidebar_func() {
    $side_bar = get_sidebar('category-pages');
    return $side_bar;
}
add_shortcode( 'cateogry_pages_sidebar', 'get_category_page_sidebar_func' );