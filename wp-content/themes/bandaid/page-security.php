...
?>
<?php
$banner_img =get_field('security_panel_header_banner');
$banner_img_url =$banner_img['url'];
$left_img =get_field('security_infra_panel_left_logo');
        ...
        <div class="container">
            <div class="row">
                <div id="left-column" class="col-md-3 col-sm-3 text-center">
                    <div class="v-center">
                        <div class="v-in">
                            <img class="img-responsive" src="<?php echo $left_img_url?>" alt="Security" />
                            <h1 class="bs-ap-title"><?php echo get_field('security_infra_panel_left_heading')?></h1>
                        </div>
                    </div>                
                </div>
                <div id="right-column" class="col-md-9 col-sm-9">
                    <div class="v-center">
                        <div class="v-in">
                            <?php echo get_field('security_infra_panel_right_content'); ?>
                        </div>
                    </div>
                </div>
            </div>
