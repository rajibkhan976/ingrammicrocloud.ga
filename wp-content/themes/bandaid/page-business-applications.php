...
$left_img =get_field('panel_left_logo');
            ...
            <div class="container">
                <div class="row">
                    <div id="left-column" class="col-md-3 col-sm-3 text-center">
                        <div class="v-center">
                            <div class="v-in">
                                <img class="img-responsive" src="<?php echo $left_img_url;?>" alt="Business Applications" />
                                <h1 class="bs-ap-title"><?php echo get_field('panel_left_heading'); ?></h1>
                            </div>
                        </div>
                    </div>
