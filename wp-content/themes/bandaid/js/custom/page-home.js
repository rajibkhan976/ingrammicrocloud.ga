...
function renderPromotions() {
  ...
  jQuery('#panel-promotions').html(markup);
...
jQuery(document).ready(function() {
  ...
  jQuery('#marketplace-icon .icons-in').html(getSvgIcon('marketplace') + '<div class="icon-name">Cloud<br>Marketplace</div>');
  jQuery('#referral-icon .icons-in').html(getSvgIcon('referral') + '<div class="icon-name">Cloud Referral<br>Program</div>');
  jQuery('#store-icon .icons-in').html(getSvgIcon('store') + '<div class="icon-name">Cloud Store</div>');
  jQuery('#oae-icon .icons-in').html(getSvgIcon('oae') + '<div class="icon-name">Odin Automation<br>Essentials</div>');
  jQuery('#ensim-icon .icons-in').html(getSvgIcon('ensim') + '<div class="icon-name">Ensim Automation<br>Suite</div>');
  jQuery('#oap-icon .icons-in').html(getSvgIcon('oap') + '<div class="icon-name">Odin Automation<br>Premium</div>');
  renderPromotions();
