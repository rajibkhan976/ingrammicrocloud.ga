                                ...
                                <div class="blog-left">
                                    <div class="row">                                        
                                        <div class="col-md-12 col-sm-12">
                                            <div class="blog-in-right news-padding-left">
                                                <h2>News Release</h2>
...
<!--                                                    <span class="archived-releases-pagination-span">
                                                    ...
                                                    <a href="/newsroom" class="page-scroll pull-left"><button class="btn btn-default btn-outline-gray lowercase">&lt; Newsroom</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-3">
                                <?php
                                dynamic_sidebar('newsroom-sidebar');
